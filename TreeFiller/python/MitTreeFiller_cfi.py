...
#    conversionsName                  = cms.untracked.string('mvfConversionRemoval'),
  ...
  CA8FatJetsCHS = cms.untracked.PSet(
    ...
    SubJets                                  = cms.untracked.vstring('selectedPatJetsSoftDropPFCHSPacked8:SubJets',
                                                                     'selectedPatJetsPrunedPFCHSPacked8:SubJets',
                                                                     'selectedPatJetsTrimmedPFCHSPacked8:SubJets'),
  ...
  CA15FatJetsCHS = cms.untracked.PSet(
     ...
     rhoName                                  = cms.untracked.string(''),
     pfCandMapName                            = cms.untracked.string('PFCandMapName'),
     jetMapName                               = cms.untracked.string('CA15PFJetCHSMap'),
     SubJets                                  = cms.untracked.vstring('selectedPatJetsSoftDropPFCHSPacked15:SubJets',
                                                                      'selectedPatJetsPrunedPFCHSPacked15:SubJets',
                                                                      'selectedPatJetsTrimmedPFCHSPacked15:SubJets'),
     SubJetLabels                             = cms.untracked.vstring('SoftDrop','Pruned','Trimmed'), # this order is important,
