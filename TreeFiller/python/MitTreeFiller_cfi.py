...
MitTreeFiller = cms.EDAnalyzer("FillMitTree",
  ...
  Muons = cms.untracked.PSet(
    ...
    pfCandMapName       = cms.untracked.string(''),
  ...
  AKt4PFJets = cms.untracked.PSet(
    ...
    L2JetCorrectorName                       = cms.untracked.string('ak4PFL2RelativeJetCorrector'),
    L3JetCorrectorName                       = cms.untracked.string('ak4PFL3AbsoluteJetCorrector'),
  ...
  AKt4PFJetsCHS = cms.untracked.PSet(
    ...
    jetToVertexAlphaName                     = cms.untracked.string('jetVertexAlphaAKT4PF:Var'),
    jetToVertexBetaName                      = cms.untracked.string('jetVertexBetaAKT4PF:Var'),
    L2JetCorrectorName                       = cms.untracked.string('ak4PFCHSL2RelativeJetCorrector'),
    L3JetCorrectorName                       = cms.untracked.string('ak4PFCHSL3AbsoluteJetCorrector'),
    flavorMatchingByReferenceName            = cms.untracked.string('AKT4PFbyRef'),
    flavorMatchingDefinition                 = cms.untracked.string('Algorithmic'),
  ...
  HPSTaus = cms.untracked.PSet(
    ...
    DiscriminationByMVA5VLooseElectronRejection = cms.untracked.string("hpsPFTauDiscriminationByMVA5VLooseElectronRejection"),
    DiscriminationByMVA5LooseElectronRejection = cms.untracked.string("hpsPFTauDiscriminationByMVA5LooseElectronRejection"),
    DiscriminationByMVA5MediumElectronRejection = cms.untracked.string("hpsPFTauDiscriminationByMVA5MediumElectronRejection"),
    DiscriminationByMVA5TightElectronRejection = cms.untracked.string("hpsPFTauDiscriminationByMVA5TightElectronRejection"),
    ...
    MVA3IsolationChargedIsoPtSum = cms.untracked.string("hpsPFTauMVA3IsolationChargedIsoPtSum"),
    MVA3IsolationNeutralIsoPtSum = cms.untracked.string("hpsPFTauMVA3IsolationNeutralIsoPtSum"),
    MVA3IsolationPUcorrPtSum = cms.untracked.string("hpsPFTauMVA3IsolationPUcorrPtSum"),
