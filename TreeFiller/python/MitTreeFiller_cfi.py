...
#    conversionsName                  = cms.untracked.string('mvfConversionRemoval'),
  ...
  HPSTaus = cms.untracked.PSet(
    ...
    MVA3IsolationChargedIsoPtSumName = cms.untracked.string(""),
    MVA3IsolationNeutralIsoPtSumName = cms.untracked.string(""),
    MVA3IsolationPUcorrPtSumName = cms.untracked.string(""),
