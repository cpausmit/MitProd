...
MitTreeFiller = cms.EDAnalyzer("FillMitTree",
  ...
  AKt4PFJets = cms.untracked.PSet(
    ...
    CombinedSecondaryVertexV2BJetTagsName    = cms.untracked.string('newCombinedSecondaryVertexV2BJetTags'),
    CombinedSecondaryVertexSoftLeptonBJetTagsName    = cms.untracked.string('newCombinedSecondaryVertexSoftLeptonBJetTags'),
    CombinedInclusiveSecondaryVertexV2BJetTagsName    = cms.untracked.string('newCombinedInclusiveSecondaryVertexV2BJetTags'),
    CombinedMVABJetTagsName                  = cms.untracked.string('newCombinedMVABJetTags'),
