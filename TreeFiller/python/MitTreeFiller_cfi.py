...
#    conversionsName                  = cms.untracked.string('mvfConversionRemoval'),
  ...
  AKt8FatJetsCHS = cms.untracked.PSet(
    ...
    CombinedSecondaryVertexV2BJetTagsName    = cms.untracked.string('pfCombinedSecondaryVertexV2BJetTags'),
    CombinedInclusiveSecondaryVertexV2BJetTagsName = cms.untracked.string('pfCombinedInclusiveSecondaryVertexV2BJetTags'),
    CombinedMVAV2BJetTagsName                = cms.untracked.string('pfCombinedMVAV2BJetTags'),
    BoostedDoubleSecondaryVertexBJetTagsName = cms.untracked.string('pfBoostedDoubleSecondaryVertexBJetTags'),
