...
#    conversionsName                  = cms.untracked.string('mvfConversionRemoval'),
  ...
  PFCandidates = cms.untracked.PSet(
    ...
    edmPuppiMapNames              = cms.untracked.vstring('puppi'),
  ...
  AKt4PFJets = cms.untracked.PSet(
    ...
    flavorMatchingDefinition                 = cms.untracked.string('Algorithmic'),
    JetProbabilityBJetTagsName               = cms.untracked.string('pfJetProbabilityBJetTagsAKt4PF'),
    JetBProbabilityBJetTagsName              = cms.untracked.string('pfJetBProbabilityBJetTagsAKt4PF'),
    SimpleSecondaryVertexHighEffBJetTagsName = cms.untracked.string('pfSimpleSecondaryVertexHighEffBJetTagsAKt4PF'),
    SimpleInclusiveSecondaryVertexHighEffBJetTagsName = cms.untracked.string('pfSimpleInclusiveSecondaryVertexHighEffBJetTagsAKt4PF'),
    CombinedSecondaryVertexV2BJetTagsName    = cms.untracked.string('pfCombinedSecondaryVertexV2BJetTagsAKt4PF'),
    CombinedInclusiveSecondaryVertexV2BJetTagsName = cms.untracked.string('pfCombinedInclusiveSecondaryVertexV2BJetTagsAKt4PF'),
    CombinedMVAV2BJetTagsName                = cms.untracked.string('pfCombinedMVAV2BJetTagsAKt4PF'),
    TrackCountingHighEffBJetTagsName         = cms.untracked.string('pfTrackCountingHighEffBJetTagsAKt4PF'),
    ...
    CombinedCvsBJetTagsName                  = cms.untracked.string('pfCombinedCvsBJetTagsAKt4PF'),
    CombinedCvsLBJetTagsName                 = cms.untracked.string('pfCombinedCvsLJetTagsAKt4PF'),
    pfCandMapName                            = cms.untracked.string('PFCandMap'),
  ...
  AKt4PFJetsCHS = cms.untracked.PSet(
    ...
    flavorMatchingByReferenceName            = cms.untracked.string('AKT4PFbyRef'),
    flavorMatchingDefinition                 = cms.untracked.string('Algorithmic'),
    JetProbabilityBJetTagsName               = cms.untracked.string('pfJetProbabilityBJetTagsAKt4PFCHS'),
    JetBProbabilityBJetTagsName              = cms.untracked.string('pfJetBProbabilityBJetTagsAKt4PFCHS'),
    SimpleSecondaryVertexHighEffBJetTagsName = cms.untracked.string('pfSimpleSecondaryVertexHighEffBJetTagsAKt4PFCHS'),
    SimpleInclusiveSecondaryVertexHighEffBJetTagsName = cms.untracked.string('pfSimpleInclusiveSecondaryVertexHighEffBJetTagsAKt4PFCHS'),
    CombinedSecondaryVertexV2BJetTagsName    = cms.untracked.string('pfCombinedSecondaryVertexV2BJetTagsAKt4PFCHS'),
    CombinedInclusiveSecondaryVertexV2BJetTagsName = cms.untracked.string('pfCombinedInclusiveSecondaryVertexV2BJetTagsAKt4PFCHS'),
    CombinedMVAV2BJetTagsName                = cms.untracked.string('pfCombinedMVAV2BJetTagsAKt4PFCHS'),
    TrackCountingHighEffBJetTagsName         = cms.untracked.string('pfTrackCountingHighEffBJetTagsAKt4PFCHS'),
    ...
    CombinedCvsBJetTagsName                  = cms.untracked.string('pfCombinedCvsBJetTagsAKt4PFCHS'),
    CombinedCvsLBJetTagsName                 = cms.untracked.string('pfCombinedCvsLJetTagsAKt4PFCHS'),
    pfCandMapName                            = cms.untracked.string('PFCandMap'),
  ...
  AKt4PuppiJets = cms.untracked.PSet(
    ...
    flavorMatchingByReferenceName            = cms.untracked.string('AKT4PFbyRef'),
    flavorMatchingDefinition                 = cms.untracked.string('Algorithmic'),
    JetProbabilityBJetTagsName               = cms.untracked.string('pfJetProbabilityBJetTagsAKt4PFPuppi'),
    JetBProbabilityBJetTagsName              = cms.untracked.string('pfJetBProbabilityBJetTagsAKt4PFPuppi'),
    SimpleSecondaryVertexHighEffBJetTagsName = cms.untracked.string('pfSimpleSecondaryVertexHighEffBJetTagsAKt4PFPuppi'),
    SimpleInclusiveSecondaryVertexHighEffBJetTagsName = cms.untracked.string('pfSimpleInclusiveSecondaryVertexHighEffBJetTagsAKt4PFPuppi'),
    CombinedSecondaryVertexV2BJetTagsName    = cms.untracked.string('pfCombinedSecondaryVertexV2BJetTagsAKt4PFPuppi'),
    CombinedInclusiveSecondaryVertexV2BJetTagsName = cms.untracked.string('pfCombinedInclusiveSecondaryVertexV2BJetTagsAKt4PFPuppi'),
    CombinedMVAV2BJetTagsName                = cms.untracked.string('pfCombinedMVAV2BJetTagsAKt4PFPuppi'),
    TrackCountingHighEffBJetTagsName         = cms.untracked.string('pfTrackCountingHighEffBJetTagsAKt4PFPuppi'),
    ...
    CombinedCvsBJetTagsName                  = cms.untracked.string('pfCombinedCvsBJetTagsAKt4PFPuppi'),
    CombinedCvsLBJetTagsName                 = cms.untracked.string('pfCombinedCvsLJetTagsAKt4PFPuppi'),
  ...
  AKt8FatJetsCHS = cms.untracked.PSet(
    ...
    edmName                                  = cms.untracked.string('packedAK8PFJetsCHS'),
    rhoName                                  = cms.untracked.string(''),
    pfCandMapName                            = cms.untracked.string('PFCandMap'),
    jetMapName                               = cms.untracked.string('AKt8FatJetCHSMap'),
    SubJets                                  = cms.untracked.vstring('packedAK8PFJetsCHSSoftDrop:SubJets'),
    ...
    NjettinessName                           = cms.untracked.string('njettinessAK8PFJetsCHS'),
    SDMassName                               = cms.untracked.string('sdKinematicsAK8PFJetsCHS:Mass'),
    R0                                       = cms.untracked.double(0.8),
    BoostedDoubleSecondaryVertexBJetTagsName = cms.untracked.string('pfBoostedDoubleSecondaryVertexBJetTagsAKt8PFCHS'),
  ...
  CA15FatJetsCHS = cms.untracked.PSet(
     ...
     edmName                                  = cms.untracked.string('packedCA15PFJetsCHS'),
     rhoName                                  = cms.untracked.string(''),
     pfCandMapName                            = cms.untracked.string('PFCandMap'),
     jetMapName                               = cms.untracked.string('CA15FatJetCHSMap'),
     SubJets                                  = cms.untracked.vstring('packedCA15PFJetsCHSSoftDrop:SubJets'),
     SubJetLabels                             = cms.untracked.vstring('SoftDrop'), # this order is important,
     SubJetBTagName                           = cms.untracked.string('pfCombinedInclusiveSecondaryVertexV2BJetTags'),
     NjettinessName                           = cms.untracked.string('njettinessCA15PFJetsCHS'),
     SDMassName                               = cms.untracked.string('sdKinematicsCA15PFJetsCHS:Mass'),
     R0                                       = cms.untracked.double(1.5),
     BoostedDoubleSecondaryVertexBJetTagsName = cms.untracked.string('pfBoostedDoubleSecondaryVertexBJetTagsCA15PFCHS'),
     edmPrimaryVertices                       = cms.untracked.string('offlinePrimaryVertices'),
     fillerType                               = cms.untracked.string('FillerFatJets')
   ),
  ...
  AKt8FatJetsPuppi = cms.untracked.PSet(
    ...
    edmName                                  = cms.untracked.string('packedAK8PuppiJets'),
    rhoName                                  = cms.untracked.string(''),
    pfCandMapName                            = cms.untracked.string('puppiMap'),
    jetMapName                               = cms.untracked.string('AKt8FatJetPuppiMap'),
    SubJets                                  = cms.untracked.vstring('packedAK8PuppiJetsSoftDrop:SubJets'),
    SubJetLabels                             = cms.untracked.vstring('SoftDrop'), # this order is important,
    SubJetBTagName                           = cms.untracked.string('pfCombinedInclusiveSecondaryVertexV2BJetTags'),
    NjettinessName                           = cms.untracked.string('njettinessAK8PuppiJets'),
    SDMassName                               = cms.untracked.string('sdKinematicsAK8PuppiJets:Mass'),
    R0                                       = cms.untracked.double(0.8),
    BoostedDoubleSecondaryVertexBJetTagsName = cms.untracked.string('pfBoostedDoubleSecondaryVertexBJetTagsAKt8PFPuppi'),
    edmPrimaryVertices                       = cms.untracked.string('offlinePrimaryVertices'),
    fillerType                               = cms.untracked.string('FillerFatJets')
  ),
  ...
  CA15FatJetsPuppi = cms.untracked.PSet(
     ...
     edmName                                  = cms.untracked.string('packedCA15PuppiJets'),
     rhoName                                  = cms.untracked.string(''),
     pfCandMapName                            = cms.untracked.string('puppiMap'),
     jetMapName                               = cms.untracked.string('CA15FatJetPuppiMap'),
     SubJets                                  = cms.untracked.vstring('packedCA15PuppiJetsSoftDrop:SubJets'),
     SubJetLabels                             = cms.untracked.vstring('SoftDrop'), # this order is important,
     SubJetBTagName                           = cms.untracked.string('pfCombinedInclusiveSecondaryVertexV2BJetTags'),
     NjettinessName                           = cms.untracked.string('njettinessCA15PuppiJets'),
     SDMassName                               = cms.untracked.string('sdKinematicsCA15PuppiJets:Mass'),
     R0                                       = cms.untracked.double(1.5),
     BoostedDoubleSecondaryVertexBJetTagsName = cms.untracked.string('pfBoostedDoubleSecondaryVertexBJetTagsCA15PFPuppi'),
     edmPrimaryVertices                       = cms.untracked.string('offlinePrimaryVertices'),
     fillerType                               = cms.untracked.string('FillerFatJets')
   ),
  ...
  PuppiMet = cms.untracked.PSet(
    ...
    edmName    = cms.untracked.string('pfMETPuppi'),
    fillerType = cms.untracked.string('FillerPFMetFromPFMET')
  ),
