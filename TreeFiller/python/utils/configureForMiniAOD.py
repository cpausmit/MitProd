...
#        #'PsClusters', # GED preshower clusters are of type CaloClusterCollection - either FillerPsClusters or FillerBasicClusters must be updated
    ...
    treeFiller.HPSTaus.DiscriminationByDecayModeFindingOldDMsName = 'decayModeFindingOldDMs',
    treeFiller.HPSTaus.DiscriminationByVLooseCombinedIsolationDBSumPtCorrName = 'byVLooseCombinedIsolationDeltaBetaCorr',
    treeFiller.HPSTaus.DiscriminationByLooseCombinedIsolationDBSumPtCorrName = 'byLooseCombinedIsolationDeltaBetaCorr',
    treeFiller.HPSTaus.DiscriminationByMediumCombinedIsolationDBSumPtCorrName = 'byMediumCombinedIsolationDeltaBetaCorr',
    treeFiller.HPSTaus.DiscriminationByTightCombinedIsolationDBSumPtCorrName = 'byTightCombinedIsolationDeltaBetaCorr',
    treeFiller.HPSTaus.DiscriminationByRawCombinedIsolationDBSumPtCorrName = 'byCombinedIsolationDeltaBetaCorrRaw',
